        ...
        <div class="row d-flex">
            ...
            <div class="col-lg-6">
                <div class="card2 card border-0 px-4 py-5">
                    ...
                    <div class="row px-3">
                        <label class="mb-1"><h6 class="mb-0 text-sm">Email Address or Username</h6></label>
                        <input class="form-control @error('username') is-invalid @enderror @error('email') is-invalid @enderror" name="username" value="{{ old('username') }}" type="username" name="username" placeholder="Enter a valid email address"  id="username">
                        @error('username')
